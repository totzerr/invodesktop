...
(()=>{
 ...
 const scripts=[
  ...
  'js/interface/navigation.js','js/interface/settings.js','js/interface/forecasts.js','js/interface/liquid-glass.js','js/interface/official-dashboard.js','js/interface/application.js'
 ];
